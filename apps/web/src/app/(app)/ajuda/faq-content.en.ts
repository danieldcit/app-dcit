...
// English translation of faq-content.ts. Kept as a full parallel array
// (not run through the t() dictionary) because this is long-form
// question/answer content, not short chrome labels — mirrors the Portuguese
// file's structure and order exactly so the two stay easy to diff.
export const FAQ_CATEGORIES_EN: FaqCategory[] = [
  {
    ...
    items: [
      ...
      {
        question: "What if I clock in/out without internet (on the app)?",
        answer:
    ...
    items: [
      {
        ...
        answer:
          'In your user menu (icon at the top right), tap the pencil over the photo and choose "Change photo" or "Remove photo".',
      },
      {
        question: "How do I change my password?",
        answer: 'In the user menu, tap "Change password" and enter your current and new password.',
      },
      {
        question: "How do I update my personal data (address, phone, etc.)?",
        answer:
          'In the user menu, tap "My Profile". You can edit national ID, date of birth, marital status, phone and address — name, role and salary remain exclusive to HR/manager.',
      },
    ],
  },
  {
