...
export const FAQ_CATEGORIES_ES: FaqCategory[] = [
  {
    ...
    items: [
      ...
      {
        question: "¿Qué pasa si registro sin internet?",
        answer:
    ...
    items: [
      {
        ...
        answer:
          'En la pantalla Perfil, toque el lápiz sobre la foto y elija "Tomar foto", "Galería" o "Quitar foto".',
      },
      {
        question: "¿Cómo cambio mi contraseña?",
        answer:
          'En la pantalla Perfil, toque "Cambiar contraseña" e ingrese la contraseña actual y la nueva.',
      },
      {
        question: "¿Cómo actualizo mis datos personales (domicilio, teléfono, etc.)?",
        answer:
          'En la pantalla Perfil, toque "Mi Perfil". Puede editar documento de identidad, fecha de nacimiento, estado civil, teléfono y domicilio — el nombre, el puesto y el salario siguen siendo exclusivos de RR. HH./gerente.',
      },
    ],
  },
  {
